...
*			};
*/
MALICIOUS_NODE malicious_node[] = {{2,0},{4,1000000}}; //Example:Node 2 is malicious node after time 0 sec.
...
int fn_NetSim_DSR_MaliciousRouteAddToCache(NetSim_EVENTDETAILS* pstruEventDetails)
{
	...
	DSR_RREQ_OPTION* rreq = option->options;
		...
		NETSIM_IPAddress IP_Dev2 = DSR_DEV_IP(pstruEventDetails->nDeviceId);
